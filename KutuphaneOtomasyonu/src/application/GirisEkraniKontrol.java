...
public class GirisEkraniKontrol implements Initializable{
    ...
    void giris_yap(ActionEvent event) throws IOException{
    	if(tfKA.getText().equals("Yazýlým Tasarýmý") && pfSifre.getText().toString().equals("kütüphaneotomasyonu")) {
    		...
    		lblHata.setText("Kullanýcý adý veya þifre boþ býrakýlamaz.");
    	 ...
    	 private String KS() {
 	    	...
 	    	try {
 		    	...
 		    	if(sonuç.next()) {
 		    		Kullanici_sifre = sonuç.getString(1);
 		    		sonuç.close();
